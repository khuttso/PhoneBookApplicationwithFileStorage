 ...
 *  void RemoveFromFile(T obj) removes given object from the file
 *  void AddAllToFile(IEnumerable<T> collection) Default method that adds all the data from the collection to the file
